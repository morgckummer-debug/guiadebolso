...
const TEMAS = [
  ...
  },
  {
    ...
    vejaTambem:['placenta-baixa','datacao-gestacao','femur-curto'],
  },
  {
    id:'placenta-baixa',
    ...
    passo:{tipo:'checklist', itens:[
      'No morfológico do 2º trimestre (22–24 semanas), garanta que a posição da placenta seja reavaliada e o colo do útero medido (predição de parto prematuro) — sempre por via transvaginal.',
  ...
  },
  {
    ...
    essencial:'O cordão umbilical normalmente tem 3 vasos: 2 artérias e 1 veia. Artéria umbilical única (AUU) é quando existe apenas 1 artéria e 1 veia — pode ser identificada já no morfológico do 1º trimestre. Quando é isolada, as principais preocupações são PIG/RCF (≈20%) e discreto aumento do risco de cardiopatias, sendo comum a indicação de ecocardiograma fetal.',
  ...
  },
  {
    ...
    passo:{tipo:'checklist', itens:[
      'Recomende ao casal uma consulta com o pediatra que vai acompanhar o bebê — ele pode antecipar orientações e reduzir a ansiedade da família sobre o que esperar após o parto.',
      'Explique que a evolução depende do grau de dilatação: quanto mais leve, maior a chance de resolução espontânea após o nascimento; acima de 10 mm, o risco de precisar de correção cirúrgica (pieloplastia) é maior.',
      'Programe ultrassom de controle para acompanhar a evolução ao longo da gestação.',
      'Após o nascimento, garanta o seguimento com pediatra/nefrologista pediátrico, principalmente se a dilatação for >10 mm.',
    ]},
  ...
  },
  {
    ...
    referencias:[
      ['ISUOG Practice Guidelines: performance of the routine mid-trimester fetal ultrasound scan — marcadores menores de aneuploidia. Ultrasound Obstet Gynecol, 2022.', 'https://obgyn.onlinelibrary.wiley.com/doi/10.1002/uog.24888'],
      'Foco ecogênico intracardíaco isolado e risco de aneuploidia — referência específica pendente de indicação da autora.',
    ],
    vejaTambem:['intestino-hiperecogenico','ventriculomegalia-leve','prega-nucal-espessada','femur-curto'],
  },
  {
    ...
    vejaTambem:['foco-ecogenico-intracardiaco','ventriculomegalia-leve','prega-nucal-espessada','femur-curto'],
  },
  {
    ...
    erro:'Aceitar uma medida do átrio ventricular sem considerar que ela é sensível à técnica (plano oblíquo ou calibradores mal posicionados tendem a superestimar o valor) — ou, no sentido oposto, tranquilizar a paciente diante de uma medida alterada sem investigar cariótipo, infecção congênita e anatomia cerebral completa.',
    passo:{tipo:'checklist', itens:[
      'Diante de uma medida de átrio ventricular alterada no laudo, lembre-se que ela é sensível à técnica (plano oblíquo pode superestimar o valor) — se o laudo trouxer a imagem, vale olhar você mesmo: plano bem alinhado e calibradores nas bordas internas da linha eco dão mais segurança na medida. Se o achado for isolado, a imagem parecer duvidosa, ou o resultado destoar do restante do exame, considere solicitar a repetição da medida com a ultrassonografista.',
      'Confira a classificação que a ultrassonografista já deu no laudo — normal (&lt;9mm), leve (9–11mm), moderada (12–14mm) ou grave (≥15mm) — porque é ela que muda sua conduta e o que você vai conversar com a paciente.',
      'Veja se o laudo traz a medida do córtex e do DBP: quando vierem, córtex &gt;10mm com DBP normal reforça um quadro leve, e córtex &lt;10mm com DBP aumentado é sinal de gravidade. Não é medida que você vai tirar — mas, se não constar e o caso for limítrofe, vale pedir para a ultrassonografista incluir no laudo.',
      'Confira se o laudo já avaliou o corpo caloso, o cavo do septo pelúcido e a fossa posterior — se essas estruturas não aparecerem descritas, considere solicitar uma neurossonografia ou um morfológico mais detalhado antes de fechar a conduta.',
      'Se a ventriculomegalia for leve e isolada, ofereça à paciente a investigação para aneuploidias (cariótipo/microarray, considerar NIPT) e o rastreamento de infecção congênita, principalmente citomegalovírus.',
      'Programe o retorno para USG de controle — quanto mais leve o achado, maior pode ser o intervalo (2–4 semanas); quanto mais grave, menor deve ser esse intervalo, já que a trajetória (estável, regride ou progride) pesa tanto quanto o valor isolado.',
    ]},
    ...
    vejaTambem:['intestino-hiperecogenico','foco-ecogenico-intracardiaco','prega-nucal-espessada','femur-curto'],
  },
  {
    ...
    passo:{tipo:'checklist', itens:[
      'Diante de uma prega nucal espessada, lembre-se que a medida é sensível à técnica — se o achado for isolado e discordante do restante do exame, considere solicitar a repetição da medida.',
    ...
    vejaTambem:['ventriculomegalia-leve','foco-ecogenico-intracardiaco','intestino-hiperecogenico','femur-curto'],
  },
  {
    id:'femur-curto',
    titulo:'Fêmur curto',
    modulo:'marcadores',
    tags:['fêmur curto','marcador menor','curvas de crescimento','hadlock','biometria fetal','displasia óssea','restrição de crescimento fetal','baixa estatura familiar'],
    essencial:'O fêmur é um dos ossos longos medidos na biometria fetal de rotina (junto com cabeça e abdome), usado para estimar peso e acompanhar o crescimento. "Fêmur curto" é quando essa medida fica abaixo do percentil 5 (ou &lt;-2 desvios-padrão) para a idade gestacional — um achado de medida, não uma malformação. Isolado, é bem mais provável ser datação incorreta ou baixa estatura familiar do que aneuploidia.',
    erro:'Interpretar todo fêmur curto isolado como marcador de Síndrome de Down e já encaminhar para investigação invasiva, sem antes confirmar a idade gestacional (erro de datação é a causa mais comum) e sem avaliar se há desproporção com os demais ossos longos, que mudaria a hipótese para displasia óssea.',
    passo:{tipo:'checklist', itens:[
      'Confirme a idade gestacional pela datação de 1º trimestre — um fêmur "curto" muitas vezes é só efeito de uma idade gestacional mal calculada.',
      'Verifique se é isolado ou se outros parâmetros de crescimento (peso estimado, circunferência abdominal) também estão reduzidos — nesse caso, pense em restrição de crescimento fetal, não em marcador de aneuploidia.',
      'Peça a medida do úmero (verifique se já consta no laudo do morfológico) e compare a proporção entre os ossos longos — encurtamento desproporcional, associado a tórax estreito, ossos arqueados ou fraturas, sugere displasia óssea, não marcador menor.',
      'Pergunte a estatura dos pais — fêmur curto isolado, com crescimento normal e pais de baixa estatura, é provavelmente constitucional.',
      'Se isolado, sem desproporção e sem outros marcadores: revise o rastreamento de aneuploidias já feito e discuta se agrega risco relevante — hoje, muitos serviços não usam mais o fêmur curto isolado como indicação isolada de investigação invasiva.',
    ]},
    explicar:'"O fêmur do seu bebê está um pouco menor do que a média para essa fase da gestação. Isso tem várias explicações possíveis, e a maioria delas não é motivo de preocupação — pode ser só a forma de calcular a data da gravidez, ou simplesmente porque vocês são uma família mais baixa. Vamos conferir tudo antes de tirar qualquer conclusão."',
    pensando:'Meu bebê vai ter nanismo? Ele tem Síndrome de Down? Por que só descobriram isso agora?',
    confianca:'Explicar que "fêmur curto isolado" tem uma lista longa de causas benignas antes de qualquer preocupação genética séria, e que o processo de investigação (datação, proporção, crescimento, altura dos pais) é justamente o que existe pra não alarmar à toa, ajuda a paciente a entender por que não há uma resposta imediata.',
    aprendi:'Um detalhe que pouca gente comenta: as curvas de crescimento que usamos aqui no Brasil, como a de Hadlock, foram construídas em cima de população americana, constitucionalmente mais alta que a nossa. Isso significa que boa parte dos "fêmures curtos" que vejo no dia a dia é só esse descompasso entre a curva e a nossa população — não um achado real. Aprendi que, antes de assustar a paciente com a palavra "curto", vale lembrar que o parâmetro de comparação não foi feito pensando no bebê brasileiro.',
    vocesabia:[
      'Fêmur curto isolado tem LR+ para aneuploidias (trissomias 21, 18 e 13) entre ~3,7 (meta-análise) e 8,8 (estudo nacional dinamarquês) — pequeno o suficiente pra não indicar invasiva sozinho na maioria dos protocolos atuais, mas deve compor o cálculo de risco combinado.',
      'Fêmur curto isolado também aumenta o risco de parto pré-termo antes de 34 semanas (~4x) e de recém-nascido pequeno para a idade gestacional (~4x) — vale acompanhar o crescimento, mesmo quando o cariótipo é normal.',
      'Displasias ósseas costumam vir com outros sinais além do fêmur curto: tórax estreito, ossos arqueados/angulados, fraturas, mineralização craniana anormal — revise esses achados antes de tranquilizar.',
    ],
    encaminhar:'Encaminhar para pré-natal de alto risco / medicina fetal quando houver:<ul><li>Encurtamento desproporcional entre os ossos longos, sugerindo displasia óssea</li><li>Tórax estreito, ossos arqueados/angulados ou fraturas associadas</li><li>Restrição de crescimento fetal associada</li><li>Outros marcadores ou malformações associadas</li><li>Dúvida na interpretação após confirmar datação e proporção</li></ul>',
    aula:{titulo:'Fêmur curto: datação, proporção e quando pensar em displasia óssea', pendente:true},
    referencias:[
      ['Agathokleous M et al. "Meta-analysis of second-trimester markers for trisomy 21." Ultrasound Obstet Gynecol, 2013.', 'https://obgyn.onlinelibrary.wiley.com/doi/10.1002/uog.12364'],
      ['Mathiesen JM et al. "Outcome of fetuses with short femur length detected at second-trimester anomaly scan: a national survey." Ultrasound Obstet Gynecol, 2014.', 'https://obgyn.onlinelibrary.wiley.com/doi/abs/10.1002/uog.13286'],
      ['Society for Maternal-Fetal Medicine (SMFM). "Best practice guidelines regarding prenatal evaluation and delivery of patients with skeletal dysplasia." Am J Obstet Gynecol, 2018.', 'https://www.ajog.org/article/S0002-9378(18)30590-8/fulltext'],
    ],
    vejaTambem:['ventriculomegalia-leve','foco-ecogenico-intracardiaco','intestino-hiperecogenico','prega-nucal-espessada','percentil8'],
  },
  {
...
<div class="def-row"><div class="def-term">Hoje</div><div class="def-desc">Muitos serviços evitam o termo no laudo — o uso excessivo já levou a interrupções desnecessárias.</div></div>`},
  ...
  },
  {
    ...
    erro:'Interpretar ACM de baixa resistência ou RCP reduzida em feto com peso normal como sinal de hipóxia e já indicar parto — sem considerar que pode ser um efeito técnico transitório do exame, e sem solicitar reavaliação antes de decidir a conduta. Essa "alteração" isolada, num feto AIG, já levou a muitas cesáreas e induções por iatrogenia, principalmente quando o exame é feito rápido, sem tempo para reavaliação (alta demanda de convênio, fila do SUS).',
    passo:{tipo:'checklist', itens:[
      ...
      'Diante de um laudo com ACM/RCP alterada num feto AIG, lembre-se que pressão excessiva do transdutor (principalmente em placenta anterior) e compressão de cordão pelo próprio bebê são as causas mais comuns de vasodilatação cerebral transitória — não hipóxia verdadeira.',
      'Solicite uma reavaliação (o bebê muda de posição e o cordão descomprime espontaneamente em poucos minutos) antes de considerar o achado definitivo, em vez de agir imediatamente sobre uma medida isolada.',
      ...
      'Diante de um laudo de ACM/RCP alterada em feto AIG que pareça ter sido feito de forma apressada, sem repetição da medida, considere solicitar reavaliação antes de encaminhar para a maternidade — isso evita encaminhamentos desnecessários.',
    ]},
    ...
    encaminhar:'Encaminhar para pré-natal de alto risco / medicina fetal quando houver:<ul><li>ACM de baixa resistência ou RCP reduzida confirmada após reavaliação em feto PIG/CIUR</li><li>Alteração associada de Doppler de artéria umbilical</li><li>Dúvida se o achado é técnico ou verdadeiro em feto de peso limítrofe</li></ul>',
