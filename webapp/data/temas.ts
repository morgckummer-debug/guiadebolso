...
const TEMAS = [
  ...
  },
  {
    ...
    passo:{tipo:'checklist', itens:[
      'Diante de uma medida de átrio ventricular alterada, lembre-se que ela é sensível à técnica (plano oblíquo pode superestimar o valor) — se o achado for isolado e discordante do restante do exame, considere solicitar a repetição da medida.',
